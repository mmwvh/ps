...
\subtitle{An Introduction and Showcase test}
\date{\today}
\author{lama-fan}
...
\begin{tussenpagina}{Voorbeeldpresentatie}{Gebruiksvoorwaarden \& sjablonen (juli 2014)}{img/tussenpaginabackground.jpg}
\end{tussenpagina}
\note{}
...
\begin{tussenpagina}{Tussenpagina}{Op een tussenpagina mag wel extra beeld toegevoegd worden.}{img/tussenpaginabackground.jpg}
\end{tussenpagina}
\note{
}
...
\begin{frame}
    \begin{figure}
        \includegraphics[height=0.6\paperheight]{img/image.png}
...
\begin{tussenpagina}{Examples}{Tips and Tricks}{img/tussenpaginabackground.jpg}
\end{tussenpagina}
\note{}
...
\begin{tussenpagina}{Showcase}{All supported styles in one go}{img/tussenpaginabackground.jpg}
\end{tussenpagina}
\note{}
